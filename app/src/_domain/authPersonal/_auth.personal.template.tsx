      ...
      <MainContainer>
        <LoginContainer>
          ...
          <NoticeContainer>
            ...
            <List>
              <ListItem>
                ID/PW로 로그인한 경우 민원신청 시 추가 본인 인증이 필요합니다.
              </ListItem>
              <ListItem>
                일반사업자 및 사무대행기관으로 로그인 시 사업자용 인증서를
                사용하여 주시기 바랍니다. (대표자개인인증서 사용 불가)
              </ListItem>
              <ListItem>
                보건복지분야 공동인증서는 개인/기업 사업장 회원 대상 무료로
                제공합니다.
              </ListItem>
            </List>
          </NoticeContainer>
            ...
            <LoginBtn>
              <Box display="flex" flexDirection="row" alignItems="center">
                ...
                >
                  ...
                  <SubText className="s">
                    카카오, KB 국민은행, 페이코, 통신사PASS, 삼성PASS, 네이버,
                    신한은행, 토스, 뱅크샐러드, 하나은행, NH인증서를 이용하여
                    로그인 할 수 있습니다.
                  </SubText>
                ...
                >
                  ...
                  <SubText className="s">
                    <span style={{ color: "red" }}>
                      회원인증서 관리 메뉴에서 공동인증서를 등록
                    </span>
                    해주셔야 이용이 가능해요.
                  </SubText>
                  <SubText className="s" style={{ marginTop: 0 }}>
                    처음 로그인 하는 경우, 다른 인증 수단을 선택해 주세요.
                  </SubText>
                </Box>
              </Box>
              <ArrowImage src={images.RArrow} alt="Right Arrow" />
            ...
            <LoginBtn>
              <Box display="flex" flexDirection="row" alignItems="center">
                ...
                >
                  ...
                  <SubText className="s">
                    간편비밀번호(PIN)•패턴•지문등을 이용하여 로그인 해 보세요.
                  </SubText>
                </Box>
              </Box>
              <ArrowImage src={images.RArrow} alt="Right Arrow" />
          ...
          <JoinContainer>
            ...
            <Box display="flex" flexDirection="column">
              ...
              >
                아직 미래24 회원이 아니신가요? 회원가입 하고 지역맞춤형
                취/창업지원 서비스를 편리하게 이용해 보세요.
              </Typography>
              <Typography
                sx={{
                  marginTop: "0.7rem",
