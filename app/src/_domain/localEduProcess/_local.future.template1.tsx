                ...
                <ServiceContainer>
                    <Box display='flex' flexDirection='row'>
                        ...
                        <MenuContainer>
                            ...
                            <Divider />
                            <ItemText onClick={() => {navigate("/intro")}}>-경력단절여성취업지원</ItemText>
                            <Divider />
                            <ItemText onClick={() => {navigate("/intro")}}>-내지역교육현황정보</ItemText>
                            <Divider />
                            <ItemText onClick={() => {navigate("/intro")}}>-중소기업지원사업현황</ItemText>
                            <Divider />
                        </MenuContainer>
